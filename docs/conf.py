...
project = 'ccai'
copyright = '2019, F. Corneau-Tremblay'
...
latex_documents = [
    (master_doc, 'ccai.tex', 'ccai Documentation',
     'F. Corneau-Tremblay', 'manual'),
]
...
man_pages = [
    (master_doc, 'ccai', 'ccai Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ccai', 'ccai Documentation',
     author, 'ccai', 'One line description of project.',
     'Miscellaneous'),
]
