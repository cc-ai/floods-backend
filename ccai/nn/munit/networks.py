...
class AdaINGen(nn.Module):
    ...
    def __init__(self, input_dim, params):
        ...
        self.mlp = MLP(
            style_dim, self.get_num_adain_params(self.dec), mlp_dim, 3, norm="none", activ=activ
        )
...
class AdaINGen_double(nn.Module):
    ...
    def __init__(self, input_dim, params):
        ...
        # MLP to generate AdaIN parameters
        self.mlp1 = MLP(
            style_dim, self.get_num_adain_params(self.dec1), mlp_dim, 3, norm="none", activ=activ
        )
        self.mlp2 = MLP(
            style_dim, self.get_num_adain_params(self.dec2), mlp_dim, 3, norm="none", activ=activ
        )
