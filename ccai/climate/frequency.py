...
def shift_frequency(coordinates):
    ...
    listshifts = [
        baseline_rp_shift1[warmlev, returnperiod, indexlon, indexlat],
        baseline_rp_shift2[warmlev, returnperiod, indexlon, indexlat],
        baseline_rp_shift3[warmlev, returnperiod, indexlon, indexlat],
        baseline_rp_shift4[warmlev, returnperiod, indexlon, indexlat],
        baseline_rp_shift5[warmlev, returnperiod, indexlon, indexlat],
        baseline_rp_shift6[warmlev, returnperiod, indexlon, indexlat],
        baseline_rp_shift7[warmlev, returnperiod, indexlon, indexlat],
    ]
    ...
    probability = 1 / (meanshift + 0.001) * 100
